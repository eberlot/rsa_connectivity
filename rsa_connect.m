...
%         ylabel('true-estimated distance');
    ...
    case 'twoReg_noise'
        ...
        nPart = 8;
        nVox = 1000;
        corrRDM = 0.1; % used for RDMtype==4
        numSim = 100;
        RDMtype = 1;
        varReg = [0,1,10:10:100];
        corrReg = [0:0.1:1];
        corrRDM = 1;
    ...
    case 'run_job'
    %  rsa_connect('twoReg_sharedNoise','noiseType','within','RDMtype',1)
    %  fprintf('Done 1 - within\n');
    %  rsa_connect('twoReg_sharedNoise','noiseType','between','RDMtype',1)
    %  fprintf('Done 1 - between\n');
    %  rsa_connect('twoReg_sharedNoise','noiseType','within','RDMtype',2)
    %  fprintf('Done 2 - within\n');
    %  rsa_connect('twoReg_sharedNoise','noiseType','between','RDMtype',2)
    %  fprintf('Done 2 - between\n');

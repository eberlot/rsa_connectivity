...
% INPUT:
%           X:  input matrix X to be normalized 
%           (e.g. each row  is a pattern per condition)
% OUTPUT:
%           X: normalized X
%           flag: gives output if any of the points are zero relative to
%                 the point with the largest norm
%
